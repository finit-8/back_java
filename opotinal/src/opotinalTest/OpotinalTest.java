...
//				System.out.println(userInDb);
	...
	public static void main(String[] args) {
		OpotinalTest optinalTest = new OpotinalTest();
...
//		}												이런식으로 하나하나 다 예외처리하면 너무 비효율적
		...
		// null이면 throw
		// ↓ 값이 없을 때 throw처리하는 메서드라 throw만 정의해주면 됨(어떤 예외인지 내가 클래스 만들어줘야됨)
